...
class PPMessageTest extends TestCase
{
    ...
    public function attributeSerializationInArrays()
    {
        ...
        $this->assertEquals(
            "member.attrib1=abc&member.attrib2=random+value&member=value&arrayMember(0).attrib1=abc&arrayMember(0).attrib2=random+value",
            $c->toNVPString()
        );

        $c->arrayMember[0]->value = "value";
        $this->assertEquals(
            "member.attrib1=abc&member.attrib2=random+value&member=value&arrayMember(0).attrib1=abc&arrayMember(0).attrib2=random+value&arrayMember(0)=value",
            $c->toNVPString()
        );
    ...
    public function attributeDeserialization()
    {
        ...
        $responseMap = ["member.attrib1" => "abc", "member.attrib2" => "random+value", "member" => "value"];
        $c = new AttributeContainerTestClass();
        $c->init($responseMap);
        ...
        $responseMap = ["member.attrib1" => "abc", "member.attrib2" => "random+value"];
        $c = new AttributeContainerTestClass();
        $c->init($responseMap);
    ...
    public function attributeDeserializationInArrays()
    {
        ...
        $responseMap = ["arrayMember(0)" => "value+1"];
        $c = new AttributeContainerTestClass();
        $c->init($responseMap);
        ...
        $responseMap = ["arrayMember(0).attrib1" => "abc", "arrayMember(0).attrib2" => "random+value"];
        $c = new AttributeContainerTestClass();
        $c->init($responseMap);
        ...
        $responseMap = ["arrayMember(0).attrib1" => "abc", "arrayMember(0).attrib2" => "random+value", "arrayMember(0)" => "value", "arrayMember(0).attrib1" => "xyz", "arrayMember(1).attrib1" => "attribute1"];
        $c->init($responseMap);
    ...
    public function simpleDeserialization()
    {
        ...
        $map = ["field1" => "fieldvalue1", "field2" => "field+value2"];
        $o = new SimpleTestClass();
        $o->init($map);
    ...
    public function nestedDeserialization()
    {
        ...
        $map = ["field1" => "abc", "nestedField.field1" => "fieldvalue1", "nestedField.field2" => "field+value2"];
    ...
    public function simpleListDeserialization()
    {
        ...
        $map = ["field1" => "abc", "list1(0)" => "Array", "list1(1)" => "of", "list1(2)" => "some+strings"];
    ...
    public function complexListSerialization()
    {
        ...
        $this->assertEquals(
            "list2(0).field1=somevalue1&list2(0).field2=somevalue2&list2(1).field1=another+value1&list2(1).field2=anothervalue2",
            $c->toNVPString('')
        );
    }
    ...
    public function complexListDeserialization()
    {
        ...
        $map = ["list2(0).field1" => "somevalue1", "list2(0).field2" => "somevalue2", "list2(1).field1" => "another+value1", "list2(1).field2" => "anothervalue2"];
